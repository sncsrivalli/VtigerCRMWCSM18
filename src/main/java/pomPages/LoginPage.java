...
/**
 * This class stores all the web elements and business libraries of login page of vtiger application
 * @author sncsr
 *
 */
public class LoginPage {
	...
	//Declaration 
	@FindBy(xpath="//img[@alt='logo']") private WebElement vtigerLogo;
	...
	/**
	 * This method is used to fetch the logo image of vtiger in login page
	 * @return
	 */
